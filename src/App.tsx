...
import { Play, Pause, RotateCcw, Zap, Gamepad, Target, MapPin, Activity } from 'lucide-react';
import bg from './public/background_wumpus.png';
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <Gamepad className="w-8 h-8 text-green-400" />
              ...
              <div className="flex items-center gap-3">
                ...
                <label className="px-4 py-2 rounded-lg shadow bg-gradient-to-br from-purple-600 to-purple-700 hover:from-purple-500 hover:to-purple-600 text-sm font-semibold cursor-pointer">
                  <input type="file" ref={fileInputRef} onChange={handleUploadEnv} style={{ display: 'none' }} /> Upload File
                </label>
              </div>
            </div>
          </div>
        ...
        <main className="max-w-7xl mx-auto px-6 py-8 space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="p-4 border border-cyan-700 rounded-lg shadow-inner">
              <h2 className="text-xl font-semibold mb-4 flex items-center text-cyan-300">
                <Gamepad className="w-5 h-5 mr-2" /> Inspect Mode
              </h2>
              <div className="grid grid-cols-10 gap-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="neon-panel">
              <h3 className="text-lg font-semibold mb-3 flex items-center">
                <MapPin className="w-5 h-5 mr-2 text-teal-400" /> Current Situation
              </h3>
            ...
            {lastAction && (
              <div className="neon-panel">
                <h3 className="text-lg font-semibold mb-3 text-green-300">Previous Move</h3>
